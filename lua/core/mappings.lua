...
M.general = {
  ...
  n = {
    ...
    ["<C-k>"] = { "<C-w>k", "Window up" },
    ["<C-Left>"] = { ":vertical resize -2<CR>", "decrease windows width" },
    ["<C-Right>"] = { ":vertical resize +2<CR>", "increase windows width" },

    -- save
    ["w"] = { "<cmd> w <CR>", "Save file" },
    ["ww"] = { "<cmd> wq <CR>", "Save file and quit" },
    ["q"] = { "<cmd> q <CR>", "Quit" },
    ...
    ["<C-u>"] = {"10k", "move up by 10 lines"},
    ["C-d"] = {"10j", "move down by 10 lines"},
...
M.symbols_outline = {
  ...
  n = {
    -- toggle
    ["<A-m>"] = { "<cmd> SymbolsOutline <CR>", "Toggle symbolsOutline" },
  },
}
